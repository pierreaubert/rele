...
impl Clone for InterpreterState {
    fn clone(&self) -> Self {
        InterpreterState {
            ...
            match_data: self.match_data.clone(),
            match_string: self.match_string.clone(),
            eieio_classes: self.eieio_classes.clone(),
            coding_systems: self.coding_systems.clone(),
            coding_aliases: self.coding_aliases.clone(),
            coding_priority: self.coding_priority.clone(),
