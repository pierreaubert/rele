...
(when (fboundp 'rele--buffer-install-compat)
  (rele--buffer-install-compat))
...
(when (fboundp 'rele--tty-colors-install-compat)
  (rele--tty-colors-install-compat))
(when (fboundp 'rele--dig-install-compat)
  (rele--dig-install-compat))
(when (fboundp 'rele--rfc2045-install-compat)
  (rele--rfc2045-install-compat))
(when (fboundp 'rele--abbrev-install-compat)
  (rele--abbrev-install-compat))
(when (fboundp 'rele--autoinsert-install-compat)
