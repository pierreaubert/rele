...
pub fn call(name: &str, args: &LispObject) -> Option<ElispResult<LispObject>> {
    let r = match name {
        ...
        "image-type-available-p" | "gnutls-available-p" | "libxml-available-p"
        | "dbus-available-p" | "native-comp-available-p"
        | "display-graphic-p" | "display-multi-frame-p"
        | "display-color-p" | "display-mouse-p" => Ok(LispObject::nil()),

        // Text-property stubs
        "get-char-property" | "get-pos-property"
        | "get-text-property" | "text-properties-at" => Ok(LispObject::nil()),
        "text-property-not-all" => Ok(LispObject::nil()),
        "next-property-change" | "next-single-property-change"
        | "previous-property-change" | "previous-single-property-change" => Ok(LispObject::nil()),
        ...
        "coding-system-p" | "coding-system-aliases" | "coding-system-plist" => Ok(LispObject::nil()),
        ...
        | "process-status" | "process-attributes" => Ok(LispObject::nil()),
        ...
        | "minibuffer-depth" | "recursion-depth" => Ok(LispObject::nil()),
        ...
        "last-nonminibuffer-frame" | "tty-top-frame" | "accessible-keymaps" => Ok(LispObject::nil()),

        // Marker stubs
        "mark-marker" | "mark" | "marker-insertion-type"
        | "marker-position" | "set-marker" | "copy-marker"
        ...
        // Font/charset stubs
        "font-spec" | "font-family-list" | "font-info" | "font-face-attributes" => Ok(LispObject::nil()),
        ...
        "mapp" => Ok(LispObject::from(matches!(
            ...
            LispObject::Cons(_) | LispObject::HashTable(_) | LispObject::Vector(_) | LispObject::Nil
        ))),
        ...
        // Coding system stubs
        "detect-coding-string" => Ok(LispObject::cons(LispObject::symbol("utf-8"), LispObject::nil())),
        "detect-coding-region" => Ok(LispObject::symbol("utf-8")),
        "find-coding-systems-string" | "find-coding-systems-region"
        | "find-coding-systems-for-charsets" => {
            Ok(LispObject::cons(LispObject::symbol("utf-8"), LispObject::nil()))
        }
        "coding-system-base" | "coding-system-change-eol-conversion" => {
            Ok(args.first().unwrap_or(LispObject::nil()))
        }
        "command-remapping" | "buffer-swap-text" => Ok(LispObject::nil()),
        "color-values-from-color-spec" | "color-values" | "color-name-to-rgb" => Ok(LispObject::nil()),
        "coding-system-priority-list" => Ok(LispObject::cons(LispObject::symbol("utf-8"), LispObject::nil())),
        ...
        "image-size" => Err(ElispError::EvalError("image-size: not a graphic display".to_string())),
        "image-mask-p" => Err(ElispError::EvalError("image-mask-p: not a graphic display".to_string())),
        "image-metadata" => Err(ElispError::EvalError("image-metadata: not a graphic display".to_string())),
        ...
        | "tab-bar-mode" | "popup-menu" | "x-popup-menu" => Ok(LispObject::nil()),
        ...
        | "frame-native-width" | "frame-native-height" => Ok(LispObject::integer(80)),
        ...
        | "frame-menu-bar-lines" | "frame-internal-border-width" => Ok(LispObject::nil()),
        ...
        "char-width" => {
            ...
            super::string::prim_string_width(args).ok().map_or(
        ...
        "text-char-description" | "single-key-description" => {
            super::io::prim_prin1_to_string(args).ok().map_or(
        ...
        | "indent-for-tab-command" | "indent-rigidly" | "indent-region" => Ok(LispObject::nil()),

        // Syntax / sexp stubs
        "skip-syntax-forward" | "skip-syntax-backward"
        | "skip-chars-forward" | "skip-chars-backward" => Ok(LispObject::integer(0)),
        ...
        | "abort-recursive-edit" | "exit-minibuffer" | "keyboard-escape-quit" => Ok(LispObject::nil()),
        ...
        | "gui-selection-exists-p" | "gui-selection-owner-p" => Ok(LispObject::nil()),
        ...
        | "advice--symbol-function" | "advice-eval-interactive-spec" => Ok(LispObject::nil()),
        ...
        | "libxml-parse-xml-region" | "libxml-parse-html-region" => Ok(LispObject::nil()),
